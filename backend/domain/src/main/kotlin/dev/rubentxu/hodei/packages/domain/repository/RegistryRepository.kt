...
interface RegistryRepository {
     ...
     */
    suspend fun save(registry: Registry): Registry
     ...
     */
    suspend fun findById(id: UUID): Registry?
     ...
     * @return El repositorio si existe, null en caso contrario
     */
    suspend fun findByName(name: String): Registry?
     ...
     */
    suspend fun findAll(type: RegistryType? = null): List<Registry>
